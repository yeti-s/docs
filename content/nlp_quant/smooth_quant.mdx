...
논문 [SmoothQuant: Accurate and Efficient Post-Training Quantization for Large Language Models]('https://arxiv.org/abs/2211.10438') 를 바탕으로 작성하였다.
...
## 아이디어
![](assets/smooth_quant/00_acts_weights_graph.PNG)
