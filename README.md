...
* 좌측 네이게이션의 크기가 화면보다 작아 어색해 보이는 현상을 수정하였습니다.

**2.5.0 업데이트**
> 문서의 코드와 콘텐츠를 분리하여 관리하려고 합니다.
서로의 저장소를 분리하고, 문서에서 콘텐츠를 서브모듈로 사용하도록 구조를 수정하였습니다.
문서의 코드와 콘텐츠 내용을 독립적으로 관리할 수 있도록 변경하였습니다.
